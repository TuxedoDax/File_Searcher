...
This script is going to grab everything of the specified category though, so be aware of that before attempt to assist with file or system recoveries using this tool.
